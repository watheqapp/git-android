...
// */
//@RuntimePermissions
//public class MapFragment extends BaseDelegate implements OnMapReadyCallback,
...
//    }
//
//    public static MapFragment newInstance(ClientInfoModel clientInfoModel) {
...
//        } else
//            MapFragmentPermissionsDispatcher.inOnCreateViewWithPermissionCheck(this, null, null, null);
//    }
//
//    @Override
...
//
//        getParentActivity().setLat(mCurrLocationMarker.getPosition().latitude);
//        getParentActivity().setLng(mCurrLocationMarker.getPosition().longitude);
//        getActivity().onBackPressed();
////        if (clientInfoModel.isAuth())
////            pushFragment(PickDateFragment.getInstance(clientInfoModel), false);
////        else
////            pushFragment(PickDateForArrivingFragment.getInstance(clientInfoModel), false);
//    }
//}
