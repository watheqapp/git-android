...
//                ((MainActivity) getActivity()).updateToolbarTitle(getString(R.string.auth_for), (500 / 6) * 4);
//            else
//                ((MainActivity) getActivity()).updateToolbarTitle(getString(R.string.auth_for), (500 / 5) * 3);
//        }
